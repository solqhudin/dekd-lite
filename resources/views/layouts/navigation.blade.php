<nav x-data="{ open: false }" class="bg-white/90 backdrop-blur border-b border-gray-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center gap-8">
                ...
                <div class="hidden sm:flex items-center gap-6 text-sm font-medium">
                    ...
                    <a href="{{ route('announcements.index') }}"
                       class="inline-flex items-center border-b-2 px-1.5 pb-1
                              {{ request()->routeIs('announcements.*') ? 'border-orange-500 text-gray-900' : 'border-transparent text-gray-500 hover:text-gray-900 hover:border-gray-200' }}">
                        ประชาสัมพันธ์
                    </a>

                    {{-- แอดมิน (เฉพาะ role:admin) --}}
                    @auth
            ...
            {{-- Right: Mobile Hamburger + Quick Create --}}
    ...
    <div :class="{ 'block': open, 'hidden': ! open }" class="hidden sm:hidden border-t border-gray-100 bg-white">
        ...
        @guest
            <div class="pt-3 pb-4 border-t border-gray-100 space-y-1">
