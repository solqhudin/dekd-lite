...
<div class="max-w-6xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
    ...
    <section class="mb-12">
        ...
        @else
            ...
            <div class="mt-4">
                {{ $publishedPosts->appends(request()->except('posts_page'))->links() }}
            </div>
        @endif
    </section>
                ...
                @foreach($annPending as $a)
                    <div class="p-4 rounded-2xl bg-white border border-amber-200 shadow-sm">
                        ...
                        <div class="text-xs text-gray-500 mt-0.5">
                            หมวด: {{ $a->category ?: '-' }}
                            · สร้างเมื่อ {{ optional($a->created_at)->format('d/m/Y H:i') }}
                        </div>
                ...
                <table class="min-w-full text-xs">
                    <thead>
                        <tr class="bg-gray-50 text-gray-500">
                            ...
                            <th class="px-4 py-2 text-left w-32">แก้ไข</th>
                            <th class="px-4 py-2 text-left w-32">ลบ</th>
                        </tr>
                    </thead>
